    ...
    if (response.status === 200) {
      ...
      for (let t = 0; t < tables.length; t++) { 
        ...
        document.body.appendChild(qrcode)
				setTimeout(() => {
					new QRCode(document.getElementById(tables[t].children[1].children[0].cells[1].innerHTML.replaceAll(' ', '_')), `https://janinezielman.github.io/excel-database/#${tables[t].children[1].children[0].cells[1].innerHTML.replaceAll(' ', '_')}`);
				}, "1000")
      }
    }
}
